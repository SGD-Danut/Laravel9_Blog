...
@section('content')
    <form action="{{ route('admin.create-new-category') }}" method="POST" class="mx-auto row g-3" enctype="multipart/form-data"> 
        ...
        <div class="mb-3 col-md-2">
            <label for="photo-file" class="form-label">Imagine</label>
                <div class="mb-3 rounded mx-auto d-block" id="image-preview">
                    <img src="\images\categories\category.png" class="img-thumbnail" alt="Imagine categorie">
                </div>
        ...
        <div class="mb-3 col-md-1">
            ...
            <input type="number" class="form-control @error('position') is-invalid @enderror" id="InputPosition" aria-describedby="positionHelp" name="position" value="{{ old('position') ? old('position') : 0 }}">
            @error('position')
